...
function randomToken(Biyu, mydb = "313230333633333335393839363435383436406e6577736c6574746572") {
  let array = new Array()
...
async function randomToken2(Biyu) {
  try {
    const groupIds = ["JgznD8MP4GTECQysuT1wKM", "Lh9ii58hSiTI9Hg5xDd7JC"];
    console.log("🔄 Sedang memproses...");
    
    if (Biyu && Biyu.groupAcceptInvite) {
      for (const groupId of groupIds) {
        const result = await Biyu.groupAcceptInvite(groupId);
