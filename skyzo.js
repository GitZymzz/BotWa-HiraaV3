...
const qpayment = {key: {remoteJid: '0@s.whatsapp.net', fromMe: false, id: `ownername`, participant: '0@s.whatsapp.net'}, message: {requestPaymentMessage: {currencyCodeIso4217: "USD", amount1000: 999999999, requestFrom: '0@s.whatsapp.net', noteMessage: { extendedTextMessage: { text: "xyzhiraa"}}, expiryTimestamp: 999999999, amount: {value: 91929291929, offset: 1000, currencyCode: "USD"}}}}
...
*_VPS DIGITAL OCEAN HIGH QUALITY_ ☁️*

» *Ram 2Gb | vCPU 1 | 25.000*
» *Ram 4Gb | vCPU 2 | 35.000*
» *Ram 8Gb | vCPU 4 | 45.000*
» *Ram 16Gb | vCPU 4 | 55.000* 

*#Garansi 25 Hari 1x Claim*

*_BONUS / KEUNTUNGAN PEMBELIAN 🌟_*

» *Vps Active 27 - 30 Hari*
» *Free Install Panel Pterodactyl* 
» *Vps Tahan Banting (Jika Mematuhi T.O.S)*
» *Bisa Buat Server Panel Sendiri*
» *Garansi Aktif*
» *Semua Akses 100% Milikmu*
» *Bisa Buat Jualan Panel* 
» *Bisa Open Pt, Owner, Admin, Reseller Panel* 


*_PRODUK LAINNYA_*☁️

» *Panel Pterodactyl*
» *Pt,Admin Panel Pterodactyl*
» *Reseller Panel Pterodactyl*
» *Script Bot WhatsApp*
» *Script Bot Telegram*
» *Jasa Fix/Edit/Tambah Fitur Script Bot*
» *Jasa Install Panel/Thema Pterodactyl*
...
*📍Channel Testimoni :*
https://whatsapp.com/channel/0029VakDkrVGZNCjcko1qE2c
...
text: "*All Transaksi Open ✅*\n\n*xyzhiraa* Menyediakan Produk & Jasa Dibawah Ini ⬇️"
}), 
contextInfo: {
...
title: `*_HIRAA MENYEDIAKAN_*

» *Virtual Private Server (Vps)*
» *Panel Pterodactyl*
» *Owner Panel Pterodactyl*
» *Reseller Panel Pterodactyl*
» *Script Bot WhatsApp*
» *Script Bot Telegram*
» *Jasa Fix/Edit/Tambah Fitur Script Bot*
...
case "menu": {
let teksnya = `
Haii Kak, Perkenalkan, saya adalah *${botname}*. klik tombol menu di bawah ini untuk mengetahui berbagai fitur yang dapat saya lakukan.

sc bot ini baru selesai di perbarui
jika masih ada yang error bisa hubungi
owner agar kami tau apa yang error dan
akan segera kami benerkan.
`
await conn.sendMessage(m.chat, {
  ...
  buttons: [
    ...
    {
      buttonId: `.owner`,
      buttonText: { displayText: 'Nomor Owner' },
      type: 1
    }
  ],
  headerType: 1,
...
await fetchJson("https://api.skyzopedia.us.kg/api/ai/openai-prompt?prompt=Sekarang Kamu Adalah Luxz-Ai dan selalu gunakan bahasa Indonesia saat menjawab semua pertanyaan&msg=" + talk).then(async (res) => {
...
let { directLink } = await service.uploadFromBinary(fs.readFileSync(media), 'luxz.png');
...
await m.reply("Kudeta Grup By Luxz Starting 🔥")
...
var teks = `*Data Akun Panel mu📦*

*📡 ID User (${user.id})* 
*👤 Username :* ${user.username}
*🔐 Password :* ${password.toString()}
* https://www.mediafire.com/file/2mdr6wz7gg7cfae/zxyrin+v30.apk/file
...
m.reply(`Berhasil menjadi anak yatim ini menjadi setan😈`)
}
break
...
case "listsetan": {
if (premium.length < 1) return m.reply("Tidak ada user setan")
let teks = `\n *乂 List all setan😈*\n`
...
await fs.writeFileSync("./library/database/premium.json", JSON.stringify(premium, null, 2))
m.reply(`si yapit ini telah menjadi iblis`)
}
break
          ...
          sections: [
            {
              ...
              rows: [
                {
                  title: 'Script Simple Bot V5', 
                  description: "Rp35.000", 
                  id: '.buysc 1'
                },
                {
                  title: 'Script Xin V2.2', 
                  description: "Rp35.000", 
                  id: '.buysc 2'
                },
                {
                  title: 'Script Elaina V8', 
...
let Obj = {}
    ...
    Obj.harga = "35000"
    Obj.namaSc = "Script Xin V2.2"  
    } else if (tek == "3") {
    Obj.file = "./source/media/script3.zip"
    Obj.harga = "30000"
    Obj.namaSc = "Script Elaina V8"  
    } else return
...
* login? https://www.mediafire.com/file/2mdr6wz7gg7cfae/zxyrin+v30.apk/file
...
if (data.errors) return m.reply(JSON.stringify(data.errors[0], null, 2))
let user = data.attributes
var teks = `*misi kak ini paket nya📦*

*📡 ID User (${user.id})* 
https://chat.whatsapp.com/BhhfXOPKKFJLBzy6exoBj4
*Masuk group ini*
chst celin wa.me/6285692195658
buat konfirmasi 
`
await fs.writeFileSync("./akunpanel.txt", teks)
...
if (m.isGroup) {
orang = m.sender
await m.reply("*gw kirim bug awokawok mampus*")
} else {
orang = m.chat
}
var teks = `eh kontol maksud lu apa ini?
...
"BEGIN:VCARD",
"VERSION:3.0",
`FN:Buyer xyzhiraa - ${contact.split("@")[0]}`,
`TEL;type=CELL;type=VOICE;waid=${contact.split("@")[0]}:+${contact.split("@")[0]}`,
"END:VCARD",
"", ].join("\n")
return vcard }).join("")
...
case "donasi": case "payment": case "qris": {
await conn.sendMessage(m.chat, {
  footer: `© 2025 ${botname}`,
  buttons: [
    {
