...
return {
conversation: 'WhatsApp Bot By xyzhira'
}}})
...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*P tolong jangan lupa subscribe channel hiraa*
youtube.com/@hiraazxd

dan jangan lupa join channel hira
 https://whatsapp.com/channel/0029Vay6o2QKLaHpUQGAOA2Z so you can get the latest updates about this script :)`.toString()}`})
console.log(chalk.blue.bold(`hiraV3 berhasil nyala ✓\n\n`))
randomToken(Sky)
...
try {
const qtext = {key: {remoteJid: "status@broadcast", participant: "0@s.whatsapp.net"}, message: { "extendedTextMessage": {"text": "[ *hiraV3* ]"}}}
